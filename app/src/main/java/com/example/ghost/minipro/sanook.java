...
public class sanook extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sanook);
        ...
        new AsyncTask<Void,Void,Void>(){
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                progressDialog = new ProgressDialog(sanook.this);
            ...
            protected Void doInBackground(Void... params) {
                try {
                    ...
                    URL url = new URL("https://api.rss2json.com/v1/api.json?rss_url=http%3A%2F%2Frssfeeds.sanook.com%2Frss%2Ffeeds%2Fsanook%2Fsport.football.xml");
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                ArrayAdapter<String> myAdepter = new ArrayAdapter<String>(sanook.this,
                        android.R.layout.simple_list_item_1, android.R.id.text1, exData);
                jsonListview.setAdapter(myAdepter);
                ...
                jsonListview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent,
                        ...
                        String itemValue = (String) jsonListview
